...
function showSection(id) {
  ...
  // Explore is a side-by-side comparison rather than a prose panel, so it uses the
  // wider workspace width from docs/DESIGN.md — enough for all four build platforms
  // to sit on one row. Every other section keeps the 1024px reading width.
  const main = document.querySelector('.main-container');
  if (main) main.classList.toggle('main-container--wide', id === 'exploration-section');
